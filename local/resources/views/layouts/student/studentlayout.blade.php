					...
					<ul class="dropdown-menu">
						...
						<li>
							...
							<a href="{{URL_BOOKMARKS.Auth::user()->slug}}">
								...
								<sapn><i class="fa fa-bookmark" aria-hidden="true"></i> {{ getPhrase('my_bookmarks') }}</sapn>
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				...
				<ul class="nav navbar-nav side-nav {{$block_class}}">
					...
					<ul id="exams" class="collapse sidemenu-dropdown">
						...
						<li><a href="{{URL_QUIZ_GET_SCHEDULED_EXAMS.Auth::user()->slug}}"><i class="fa fa-clock-o"></i>{{ getPhrase('scheduled_exams') }}</a></li>
