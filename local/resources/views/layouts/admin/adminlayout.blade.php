 ...
 ?>
	<div id="wrapper" class="{{$class}}">
		...
		<aside class="left-sidebar">			<div class="collapse navbar-collapse navbar-ex1-collapse">				<ul class="nav navbar-nav side-nav">					<li {{ isActive($active_class, 'dashboard') }}>
            	...
            	<li><a href="{{URL_OFFLINEEXMAS_QUIZ_CATEGORIES}}"> <i class="fa fa-sort-amount-asc" aria-hidden="true"></i> {{ getPhrase('offline_exams_categories')}}</a></li>
					...
					<ul id="lms" class="collapse sidemenu-dropdown">
							<li><a href="{{ URL_LMS_CATEGORIES }}"> <i class="fa fa-random"></i>{{ getPhrase('lms_categories') }}</a></li>
							<li><a href="{{ URL_LMS_CONTENT }}"> <i class="icon-books"></i>{{ getPhrase('lms_contents') }}</a></li>
							<li><a href="{{ URL_LMS_SERIES }}"> <i class="fa fa-list-ol"></i>{{ getPhrase('lms_series') }}</a></li>
					</ul>
					</li>
