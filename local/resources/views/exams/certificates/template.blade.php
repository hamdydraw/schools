...
<body>
    ...
    <div style="width:800px; margin: 0 auto; min-height:600px; padding:20px; text-align:center;  box-sizing:border-box; border: 10px solid #787878; position:relative;overflow: hidden;" id='printarea'>
