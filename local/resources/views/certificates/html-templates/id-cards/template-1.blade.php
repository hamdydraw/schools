            ...
            <td width="50%" valign="top">
                <div style="border:1px solid #aaa; border-radius: 10px; padding:15px; min-height: 470px;">
                    <table cellpadding="0" width="100%" cellspacing="0" border="0"
                        ...
                        <tr>
                            <td align="center" style="padding: 5px 10px; ">
                                <h1 style="font-size: 24px; margin: 0;color: #0870b6;">{{getPhrase(getSetting('institute_title','id_card_settings'))}}</h1>

                                <p style="margin: 0;">
                                    <strong>{{getPhrase(getSetting('institute_address','id_card_settings'))}}</strong></p>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                                <img src="{{getProfilePath($users_list[$std]['image'],'profile')}}" width="120" alt="">
                                            ...
                                            @for($i=0; $i< $settings['front_total_fields']['value'];$i++)
                                                ...
                                                @if($settings[$front[$i]]['value'] !== 'skip')
                                                    <tr>
                                                     ...
                                                     {{getPhrase(getPhrase($settings[$front[$i]]['value']))}} &nbsp;:</span>
