				...
				<div class="panel panel-custom">
					<div class="panel-heading">
						...
						<div class="pull-right messages-buttons">
							...
							<a href="{{URL_AUTHORS_ADD}}" class="btn  btn-primary button helper_step1" >{{ getPhrase('create')}}</a>
...
@section('footer_scripts')
 ...
 @include('common.datatables', array('route'=>'authors.dataTable'))
 @include('common.deletescript', array('route'=>URL_AUTHORS_DELETE))
