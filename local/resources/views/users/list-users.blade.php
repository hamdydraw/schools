		...
		<div class="panel panel-custom" >
			<div class="panel-heading">
				...
				<div class="alert alert-info">
					<strong>{{getPhrase('Note')}}:</strong> {{getPhrase('If_the_student_admission_details_are_not_updated_those_students_will_be_available_in_all_users_list')}}, {{getPhrase('for_all_users_list')}}  &nbsp;<a href="{{URL_USERS."users"}}" class="btn  btn-warning button btn-xs">{{ getPhrase('Click_here')}}</a>
				</div>
				@endif
			</div>
