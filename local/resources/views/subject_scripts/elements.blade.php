<div class="row">
    <fieldset class="form-group col-md-6">
        ...
        <select name="year123" class="form-control"  required="required" ng-model="current_year_sc" ng-change="getCourses()">
    ...
    <fieldset class="form-group col-md-6">
        ...
        <span class="text-red">*</span>
        <select name="sem123" class="form-control" required="required" ng-model="current_sem_sc" ng-change="getSubjects()">
