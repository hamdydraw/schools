				...
				<div class="panel panel-custom">
					<div class="panel-heading">
						...
						<div class="pull-right messages-buttons">
							...
							<a href="{{URL_SUBJECTS_IMPORT}}" class="btn  btn-primary button helper_step1" >{{ getPhrase('import')}}</a>
							<a href="{{URL_SUBJECTS_ADD}}" class="btn  btn-primary button helper_step2" >{{ getPhrase('create')}}</a>
