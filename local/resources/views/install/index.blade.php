		...
		<div class="input-group-addon"><i class="fa fa-bolt" aria-hidden="true"></i></div>
		 	 ...
		 	 required
		 	  ...
		 	  >
  			 	...
  			 	<option value="school">Install With School Data</option>
  			 	<option value="college">Install With +2 Data</option>
  			 	<option value="degree">Install With Degree Data</option>
  			 	<option value="pg">Install With PG Data</option>
  			 	<option value="university">Install With University Data</option>
  			 </select>
