    ...
    public function getDatatable($slug = '')
    {
      ...
      if(!checkRole(getUserGrade(2)))
      {
        ...
        $records = array();
            ...
            $records = Couponcode::select(['title', 'coupon_code', 'discount_type', 'discount_value', 'minimum_bill','discount_maximum_amount','usage_limit', 'status', 'id','slug','created_by_user','updated_by_user','created_by_ip','updated_by_ip','created_at','updated_at'])
